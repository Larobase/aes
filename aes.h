 ...
 * @Last modified by: Hélène
 * @Last modified time: 08-10-2025
 * @License: GPL
 */
#ifndef AES_H
#define AES_H
...
void KeyGen(uint8_t roundkeys[][STATE_ROW_SIZE][STATE_COL_SIZE], uint8_t master_key
                                                                     [STATE_ROW_SIZE][STATE_COL_SIZE]);
...
void MessageToState(uint8_t state[STATE_ROW_SIZE][STATE_COL_SIZE], uint8_t message
                                                                       [DATA_SIZE]);
void StateToMessage(uint8_t message[DATA_SIZE], uint8_t state
                                                    [STATE_ROW_SIZE][STATE_COL_SIZE]);
